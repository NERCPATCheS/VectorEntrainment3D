...
%
% Processing entrainment metrics derive from two spatially matched images.
...
% image set must be located in '/Matrix/' subfolder.
%
...
% Image must be a top down view such that layers are normal to z-axis.
% During the STEP3 run, the code creates two more folders, 'Rotated' and 
% 'Surface', in the '/out/' parent folder.
%
...
%
% *NOTE: ImgSurfaces and ImgExposure must be run sequentially as returns
% from the former are used as subroutine arguments for the latter.
%
% Please see details in the README.md file located on the PATCheS Project 
% GitHub page (https://github.com/NERCPATCheS/VectorEntrainment3D).
%
